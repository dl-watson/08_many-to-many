...
app.post("/students", (req, res, next) => {
  return Student.create(req.body.name, req.body.enrolled)
...
app.put("/classes/:id", (req, res, next) => {
  return Class.update(req.params.id, req.body.title)
    .then((data) => res.send(data))
    .catch(next);
});

app.delete("/classes/:id", (req, res, next) => {
  return Class.delete(req.params.id)
    .then((data) => res.send(data))
    .catch(next);
});
